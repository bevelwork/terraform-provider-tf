...
resource "factorio_entity" "power_pole_random" {
  for_each = { for i, val in [
    { x = 24, y = 6 }, # connect to main power bus
    { x = 10, y = 0 },
    { x = 14, y = 0 },
    { x = 58, y = 2 },
    { x = 65, y = 3 },
    # connect belt assembler
  ] : i => val }
  name = "small-electric-pole"
  position {
    x = each.value.x
...
resource "factorio_entity" "copper_output_split_for_wires" {
  position {
    x = 37
    y = 10
  }
...
resource "factorio_entity" "copper_plate_output_west_run" {
  count = 20
  name  = "express-transport-belt"
  position {
    x = 37 - count.index
...
resource "factorio_entity" "copper_plate_feed_wire_assembler" {
  name = "express-transport-belt"
  position {
    x = 17
    y = 9
...
resource "factorio_entity" "copper_wire_output_west_run" {
  count = 6
  name  = "express-transport-belt"
  position {
    x = 23 - count.index
...
resource "factorio_entity" "copper_wire_feed_belt_assembler" {
  name = "express-transport-belt"
  position {
    x = 17
    y = -9
...
module "copper_wire_belt_assembler" {
  source = "./modules/one_lane_assembler"
  for_each = { for idx, vals in [
    { x = 17, y = -10 },
  ] : idx => vals }
...
resource "factorio_entity" "cog_output_belt_west_post_split" {
  count = 22
  name  = "express-transport-belt"
  position {
    x = 56 - count.index
...
resource "factorio_entity" "feed_science_assembler" {
  count = 5
  name  = "express-transport-belt"
  position {
    x = 34
...
module "science_assembler" {
  ...
  kind = "automation-science-pack"
  qty  = 10
}

resource "factorio_entity" "iron_plates_output" {
  for_each = { for idx, val in [
    { x = 64, y = 5, direction = "north" },
    { x = 64, y = 0, direction = "south" },
  ] : idx => val }
  name = "express-underground-belt"
  position {
    x = each.value.x
...
resource "factorio_entity" "left_run_plates" {
  count = 10
  name  = "express-transport-belt"
  position {
    x = 65 - count.index
...
resource "factorio_entity" "cog_splitter" {
  position {
    x = 57
    y = 3
  }
...
resource "factorio_entity" "cog_join_with_plates" {
  for_each = { for i, val in [
    { x = 56, y = 3, direction = "west" },

    { x = 55, y = 3, direction = "north" },
    { x = 55, y = 2, direction = "north" },
    { x = 55, y = 1, direction = "north" },
    { x = 55, y = 0, direction = "north" },
    { x = 55, y = -1, direction = "north" },
    { x = 55, y = -2, direction = "north" },
  ] : i => val }
  name = "express-transport-belt"
...
resource "factorio_entity" "steel_plate_feed_circuits_west_run" {
  count = 26
  name  = "express-transport-belt"
  position {
    x = 53 - count.index
...
resource "factorio_entity" "steel_plate_join_copper_wire" {
  name = "express-transport-belt"
  for_each = { for i, val in [
    { x = 27, y = 4, direction = "south" },
    { x = 27, y = 5, direction = "south" },
    { x = 27, y = 6, direction = "south" },
    { x = 27, y = 7, direction = "south" },
    { x = 27, y = 8, direction = "west" },
    { x = 26, y = 8, direction = "west" },
    { x = 25, y = 8, direction = "west" },
    { x = 24, y = 8, direction = "west" },
    { x = 23, y = 8, direction = "north" },
  ] : i => val }
  position {
    x = each.value.x
    y = each.value.y
